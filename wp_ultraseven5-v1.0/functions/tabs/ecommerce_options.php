...
<?php
	add_filter('ci_panel_tabs', 'ci_add_tab_ecommerce_options', 50);
...
<?php else: ?>
	...
	<fieldset class="set">
		...
		<?php ci_panel_radio('product_columns', '3', '4', __('4 Columns', 'ci_theme')); ?>
		<?php ci_panel_radio('product_columns', '5', '5', __('5 Columns', 'ci_theme')); ?>
		<?php ci_panel_radio('product_columns', '6', '6', __('6 Columns', 'ci_theme')); ?>
