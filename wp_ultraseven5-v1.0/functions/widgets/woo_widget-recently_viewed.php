...
if( !class_exists('CI_WC_Widget_Recently_Viewed') ):
class CI_WC_Widget_Recently_Viewed extends WC_Widget_Recently_Viewed {
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty( $instance['title'] ) ? __( 'Recently viewed', 'ci_theme' ) : $instance['title'], $instance, $this->id_base);
