...
if( !class_exists('CI_WC_Widget_Recent_Products') ):
class CI_WC_Widget_Recent_Products extends WC_Widget_Recent_Products {
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('New Products', 'ci_theme' ) : $instance['title'], $instance, $this->id_base);
