...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'ultraseven');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'UltraSeven');
...
if(!defined('CI_DOCS'))				define('CI_DOCS', 'http://cssigniter.com/support/viewtopic.php?f=53&t=2628');
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://cssigniter.com/support/viewforum.php?f=53');
